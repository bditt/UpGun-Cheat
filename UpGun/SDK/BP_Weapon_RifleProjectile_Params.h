...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Weapon_RifleProjectile.BP_Weapon_RifleProjectile_C.SpawnPierceDecal
	 */
	struct ABP_Weapon_RifleProjectile_C_SpawnPierceDecal_Params
	{
	public:
		struct FVector                                             HitLocation;                                             // 0x0000(0x000C)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		struct FVector                                             HitNormal;                                               // 0x000C(0x000C)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct ABP_Weapon_RifleProjectile_C_PierceCollisions_Params
	{
	public:
		...
		unsigned char                                              UnknownData_ZRXU[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct ABP_Weapon_RifleProjectile_C_DecalParticle_Params
	{	};
