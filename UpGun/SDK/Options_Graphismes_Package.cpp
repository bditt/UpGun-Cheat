...
namespace CG
{
	 ...
	 */
	void UOptions_Graphismes_C::Setantialiasing(int32_t* AliasingLevel)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Options_Graphismes.Options_Graphismes_C.Set antialiasing");
		
		UOptions_Graphismes_C_Setantialiasing_Params params {};
	 ...
	 */
	void UOptions_Graphismes_C::Generatecombobox(class UComboBoxString** NewParam, TArray<class FText>* Options)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Options_Graphismes.Options_Graphismes_C.Generate combobox");
		
		UOptions_Graphismes_C_Generatecombobox_Params params {};
	 ...
	 * 		class FString                                      Patatetrue                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	 */
	void UOptions_Graphismes_C::ExecuteConsoleCommand(const class FString& Command, bool* _bool_, const class FString& Default, const class FString& Patatetrue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
