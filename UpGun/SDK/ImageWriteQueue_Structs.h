...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_GHL0[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9D2V[0x46];                                  // 0x001A(0x0046) MISSED OFFSET (PADDING)
	};
