...
namespace CG
{
	 ...
	 */
	struct UHUD_PlayerMain_C_HomingBulletsTrace_Params
	{	};

	/**
	 * Function HUD_PlayerMain.HUD_PlayerMain_C.Place Widget on Screen
	 */
	struct UHUD_PlayerMain_C_PlaceWidgetonScreen_Params
	{
	public:
		...
		unsigned char                                              UnknownData_GDO0[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
