...
namespace CG
{
	 ...
	 */
	class AGC_Burning_C : public AGameplayCueNotify_Actor
	{
	public:
		...
		class UW_Fire_C*                                           FIRE_Widget;                                             // 0x0298(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_GC_Burning(int32_t EntryPoint);
