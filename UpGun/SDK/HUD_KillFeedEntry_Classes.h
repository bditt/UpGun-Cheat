...
namespace CG
{
	...
	public:
		...
		class AUpGunBasePlayerController*                          LocalPlayerController;                                   // 0x02C0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
