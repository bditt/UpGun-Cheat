...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_Weapon_RifleProjectile.BP_Weapon_RifleProjectile_C.SpawnPierceDecal
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FVector                                     HitLocation                                                (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 * 		struct FVector                                     HitNormal                                                  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_Weapon_RifleProjectile_C::SpawnPierceDecal(struct FVector* HitLocation, struct FVector* HitNormal)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Weapon_RifleProjectile.BP_Weapon_RifleProjectile_C.SpawnPierceDecal");
		
		ABP_Weapon_RifleProjectile_C_SpawnPierceDecal_Params params {};
	 ...
	 */
	void ABP_Weapon_RifleProjectile_C::PierceCollisions(ECollisionResponse NewResponse)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Weapon_RifleProjectile.BP_Weapon_RifleProjectile_C.Pierce Collisions");
		
		ABP_Weapon_RifleProjectile_C_PierceCollisions_Params params {};
