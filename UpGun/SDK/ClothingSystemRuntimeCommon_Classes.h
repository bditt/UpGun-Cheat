...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_R4KD[0x4];                                   // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FK3Z[0x4];                                   // 0x01EC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4WDB[0x20];                                  // 0x0168(0x0020) MISSED OFFSET (PADDING)
