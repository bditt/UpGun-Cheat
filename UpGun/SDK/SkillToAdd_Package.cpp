...
namespace CG
{
	 ...
	 */
	void USkillToAdd_C::CanAddSecondaryWeapons(bool* CanAddExtention)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SkillToAdd.SkillToAdd_C.Can Add Secondary Weapons");
		
		USkillToAdd_C_CanAddSecondaryWeapons_Params params {};
	 ...
	 */
	void USkillToAdd_C::IsAvailable(bool* CanBeEdited, bool* IsAvailableToAdd)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SkillToAdd.SkillToAdd_C.Is Available");
		
		USkillToAdd_C_IsAvailable_Params params {};
