...
namespace CG
{
	 ...
	 */
	struct UWID_Scoreboard_Player_C_UpdateKickBanButtons_Params
	{	};
	 ...
	 */
	struct UWID_Scoreboard_Player_C_Highlightplayer_Params
	{
	public:
		bool                                                       HighLight;                                               // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_6CZS[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
