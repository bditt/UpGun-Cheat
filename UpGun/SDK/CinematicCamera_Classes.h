...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3CTE[0x2];                                   // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_JPKD[0x3];                                   // 0x0225(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_EX7X[0x10];                                  // 0x07F0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7CL3[0xC];                                   // 0x0854(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9H69[0x8];                                   // 0x08B8(0x0008) MISSED OFFSET (PADDING)
