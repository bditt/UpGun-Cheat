...
namespace CG
{
	...
	public:
		...
		class AUpGunGameStateBase*                                 UpGunGS;                                                 // 0x0278(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		class AUpGunBasePlayerState*                               ViewerPS;                                                // 0x0280(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
	...
	public:
		...
		void UpdateColor();
		void Get_PS(class AUpGunBasePlayerState** UpGunPS);
		void Construct();
		void Initialized();
