...
namespace CG
{
	 ...
	 */
	void UHUD_PlayerMain_C::PlaceWidgetonScreen(const struct FVector& AutoAimLocation, bool Condition, class UWidget* Widget)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HUD_PlayerMain.HUD_PlayerMain_C.Place Widget on Screen");
		
		UHUD_PlayerMain_C_PlaceWidgetonScreen_Params params {};
