...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Hexagone.BP_Hexagone_C.OnRep_Visible
	 */
	struct ABP_Hexagone_C_OnRep_Visible_Params
	{	};

	/**
	 * Function BP_Hexagone.BP_Hexagone_C.ReceiveHit
	 */
	struct ABP_Hexagone_C_ReceiveHit_Params
	{
	public:
		...
		unsigned char                                              UnknownData_73FH[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function BP_Hexagone.BP_Hexagone_C.ExecuteUbergraph_BP_Hexagone
	 */
	struct ABP_Hexagone_C_ExecuteUbergraph_BP_Hexagone_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_ZBSM[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
