...
namespace CG
{
	 ...
	 */
	struct UW_Lobby_Match_Settings_DefaultSkill_C_GetText_Entete_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_JD9F[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
