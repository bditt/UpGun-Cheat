...
namespace CG
{
	 ...
	 */
	struct UAnimBP_ThirdPersonView_C_IKSetFootLocRot_Params
	{
	public:
		...
		unsigned char                                              UnknownData_FRMR[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct UAnimBP_ThirdPersonView_C_CanJump_Params
	{
	public:
		bool                                                       ShouldJump;                                              // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
