...
namespace CG
{
	 ...
	 */
	void ABP_Deathmatch_HUD_C::OnAmmoorMagazineChanged(unsigned char NewValue, unsigned char OldValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Deathmatch_HUD.BP_Deathmatch_HUD_C.On Ammo or Magazine Changed");
		
		ABP_Deathmatch_HUD_C_OnAmmoorMagazineChanged_Params params {};
		params.NewValue = NewValue;
		params.OldValue = OldValue;
