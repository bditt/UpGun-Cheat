...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function HUD_SkillPicking_Skill.HUD_SkillPicking_Skill_C.UpdateTestedUpgrades
	 * 		Flags  -> ()
	 */
	void UHUD_SkillPicking_Skill_C::UpdateTestedUpgrades()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HUD_SkillPicking_Skill.HUD_SkillPicking_Skill_C.UpdateTestedUpgrades");
		
		UHUD_SkillPicking_Skill_C_UpdateTestedUpgrades_Params params {};
