...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_V507[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_529P[0x1];                                   // 0x080F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
