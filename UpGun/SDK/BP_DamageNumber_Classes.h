...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_F0FE[0x4];                                   // 0x0234(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class FText>                                        Text;                                                    // 0x0238(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		class UHUD_FloatingDamage_C*                               FloatingDamage;                                          // 0x0248(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
