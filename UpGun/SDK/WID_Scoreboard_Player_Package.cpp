...
namespace CG
{
	 ...
	 */
	void UWID_Scoreboard_Player_C::Highlightplayer(bool HighLight)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WID_Scoreboard_Player.WID_Scoreboard_Player_C.Highlight player");
		
		UWID_Scoreboard_Player_C_Highlightplayer_Params params {};
