...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AKSE[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function GA_Skill_Dash.GA_Skill_Dash_C.Get Forward Without Up
	 */
	struct UGA_Skill_Dash_C_GetForwardWithoutUp_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_CFC1[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
