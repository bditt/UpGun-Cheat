...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LSB9[0x4];                                   // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		TArray<struct FUpGunSkillInstance>                         SkillList;                                               // 0x0280(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
