...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PS14[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function SkillToAdd.SkillToAdd_C.Can Add Secondary Weapons
	 */
	struct USkillToAdd_C_CanAddSecondaryWeapons_Params
	{
	public:
		bool                                                       CanAddExtention;                                         // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_9CVQ[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_BRM8[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function SkillToAdd.SkillToAdd_C.Add Skill to Array
	 */
	struct USkillToAdd_C_AddSkilltoArray_Params
	{	};
	 ...
	 */
	struct USkillToAdd_C_IsAvailable_Params
	{
	public:
	 ...
	 */
	struct USkillToAdd_C_UpdateAvailability_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_FJCW[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
