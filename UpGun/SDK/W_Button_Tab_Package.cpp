...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function W_Button_Tab.W_Button_Tab_C.UpdateNotification
	 * 		Flags  -> ()
	 * Parameters:
	 * 		bool                                               Display                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UW_Button_Tab_C::UpdateNotification(bool Display)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function W_Button_Tab.W_Button_Tab_C.UpdateNotification");
		
		UW_Button_Tab_C_UpdateNotification_Params params {};
