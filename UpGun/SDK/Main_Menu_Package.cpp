...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function Main_Menu.Main_Menu_C.DLC_Promotion
	 * 		Flags  -> ()
	 * Parameters:
	 * 		int32_t                                            Reduction                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UMain_Menu_C::DLC_Promotion(int32_t Reduction)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Main_Menu.Main_Menu_C.DLC_Promotion");
		
		UMain_Menu_C_DLC_Promotion_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function Main_Menu.Main_Menu_C.CollectDefaultCosmeticsItems
	 * 		Flags  -> ()
	 * Parameters:
	 * 		TArray<struct FUpGunInventoryItem>                 Out                                                        (Parm, OutParm)
	 */
	void UMain_Menu_C::CollectDefaultCosmeticsItems(TArray<struct FUpGunInventoryItem>* Out)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Main_Menu.Main_Menu_C.CollectDefaultCosmeticsItems");
		
		UMain_Menu_C_CollectDefaultCosmeticsItems_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function Main_Menu.Main_Menu_C.HasNewItems
	 * 		Flags  -> ()
	 * Parameters:
	 * 		bool                                               ShouldNotify                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UMain_Menu_C::HasNewItems(bool* ShouldNotify)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Main_Menu.Main_Menu_C.HasNewItems");
		
		UMain_Menu_C_HasNewItems_Params params {};
		
		auto flags = fn->FunctionFlags;
		UObject::ProcessEvent(fn, &params);
		fn->FunctionFlags = flags;
		
		if (ShouldNotify != nullptr)
