...
namespace CG
{
	...
	public:
		...
		class UGI_BP_Upgun_C*                                      GameInstance;                                            // 0x0278(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		...
		struct FSlateColor                                         InColorandOpacity;                                       // 0x02F0(0x0028) Edit, BlueprintVisible
		class FName                                                InputPin;                                                // 0x0318(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
