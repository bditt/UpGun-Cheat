...
namespace CG
{
	...
	public:
		...
		class AUpGunBasePlayerState*                               UpGunPlayerState;                                        // 0x02C8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
