...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_S3RC[0xAC];                                  // 0x0000(0x00AC) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_1RRI[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_S8VN[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_DLEK[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
