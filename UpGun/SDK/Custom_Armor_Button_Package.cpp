...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function Custom_Armor_Button.Custom_Armor_Button_C.UpdatePlayerCosmeticData
	 * 		Flags  -> ()
	 */
	void UCustom_Armor_Button_C::UpdatePlayerCosmeticData()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Custom_Armor_Button.Custom_Armor_Button_C.UpdatePlayerCosmeticData");
		
		UCustom_Armor_Button_C_UpdatePlayerCosmeticData_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function Custom_Armor_Button.Custom_Armor_Button_C.Excceptions
	 * 		Flags  -> ()
	 */
	void UCustom_Armor_Button_C::Excceptions()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Custom_Armor_Button.Custom_Armor_Button_C.Excceptions");
		
		UCustom_Armor_Button_C_Excceptions_Params params {};
