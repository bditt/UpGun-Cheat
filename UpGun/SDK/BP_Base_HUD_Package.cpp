...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_Base_HUD.BP_Base_HUD_C.SeasonColors
	 * 		Flags  -> ()
	 */
	void ABP_Base_HUD_C::SeasonColors()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Base_HUD.BP_Base_HUD_C.SeasonColors");
		
		ABP_Base_HUD_C_SeasonColors_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_Base_HUD.BP_Base_HUD_C.ApplyInvertAxis
	 * 		Flags  -> ()
	 */
	void ABP_Base_HUD_C::ApplyInvertAxis()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Base_HUD.BP_Base_HUD_C.ApplyInvertAxis");
		
		ABP_Base_HUD_C_ApplyInvertAxis_Params params {};
