...
namespace CG
{
	 ...
	 * Size -> 0x197C (FullSize[0x1C34] - InheritedSize[0x02B8])
	 */
	class UAnimBP_ThirdPersonView_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_F9AZ[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_4QOW[0x2];                                   // 0x1BA2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WZFZ[0x3];                                   // 0x1BB5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6UXQ[0x3];                                   // 0x1BC5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class AUpGunGameStateBase*                                 UpGunGameStateBase;                                      // 0x1C08(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		struct FVector                                             Mutator_BigHead;                                         // 0x1C10(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_2RIY[0x4];                                   // 0x1C1C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class ABP_FootStep_C*                                      Footstep;                                                // 0x1C20(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FVector                                             IK_Loc;                                                  // 0x1C28(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void IKSetFootLocRot(struct FVector* Vector, float ForwardOffset, float RightOffset, struct FRotator* Rot, const struct FRotator& RotOffset);
		bool ShouldUseIK();
