...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Custom_Menu.Custom_Menu_C.AvailableCodes
	 */
	struct UCustom_Menu_C_AvailableCodes_Params
	{	};

	/**
	 * Function Custom_Menu.Custom_Menu_C.Update Tab Notifications
	 */
	struct UCustom_Menu_C_UpdateTabNotifications_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_AUWH[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UCustom_Menu_C_UpdateName_Params
	{
	public:
		...
		unsigned char                                              UnknownData_UK7W[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_0UVN[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_8L0L[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function Custom_Menu.Custom_Menu_C.BndEvt__Custom_Menu_W_button_HideNotif_K2Node_ComponentBoundEvent_5_Clicked_Btn__DelegateSignature
	 */
	struct UCustom_Menu_C_BndEvt__Custom_Menu_W_button_HideNotif_K2Node_ComponentBoundEvent_5_Clicked_Btn__DelegateSignature_Params
	{	};

	/**
	 * Function Custom_Menu.Custom_Menu_C.BndEvt__Custom_Menu_W_button_redeem_K2Node_ComponentBoundEvent_6_Clicked_Btn__DelegateSignature
	 */
	struct UCustom_Menu_C_BndEvt__Custom_Menu_W_button_redeem_K2Node_ComponentBoundEvent_6_Clicked_Btn__DelegateSignature_Params
	{	};

	/**
	 * Function Custom_Menu.Custom_Menu_C.BndEvt__Custom_Menu_W_button_code_K2Node_ComponentBoundEvent_8_Clicked_Btn__DelegateSignature
	 */
	struct UCustom_Menu_C_BndEvt__Custom_Menu_W_button_code_K2Node_ComponentBoundEvent_8_Clicked_Btn__DelegateSignature_Params
	{	};
