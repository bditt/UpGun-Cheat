...
namespace CG
{
	 ...
	 */
	void ABP_UpGunSpectatorPawn_C::GetAngularfromDirection(struct FVector* DirectionnalVector, float MaxDesiredRotation, float* DesiredAngle)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_UpGunSpectatorPawn.BP_UpGunSpectatorPawn_C.Get Angular from Direction");
		
		ABP_UpGunSpectatorPawn_C_GetAngularfromDirection_Params params {};
