...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_11N4[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_MV1W[0x3];                                   // 0x0001(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	};
	...
	public:
		ECustomizedToolMenuVisibility                              Visibility;                                              // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_Q90I[0x3];                                   // 0x0001(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	};
	...
	public:
		...
		unsigned char                                              UnknownData_0WI8[0xE0];                                  // 0x0108(0x00E0) MISSED OFFSET (PADDING)
	};
