...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0TMH[0x7];                                   // 0x02B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void CanAddSecondaryWeapons(bool* CanAddExtention);
		void IsSkillCompatible(bool* Available);
		void AddSkilltoArray();
		void RemoveAbilityFromArray();
		void IsAvailable(bool* CanBeEdited, bool* IsAvailableToAdd);
