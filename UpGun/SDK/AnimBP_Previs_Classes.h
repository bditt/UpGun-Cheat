...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_SJ78[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_0RTO[0x4];                                   // 0x06E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
