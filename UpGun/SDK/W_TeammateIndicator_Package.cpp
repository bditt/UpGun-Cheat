...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class AUpGunBasePlayerState*                       UpGunPS                                                    (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	 */
	void UW_TeammateIndicator_C::Get_PS(class AUpGunBasePlayerState** UpGunPS)
	{
		static UFunction* fn = nullptr;
		if (!fn)
