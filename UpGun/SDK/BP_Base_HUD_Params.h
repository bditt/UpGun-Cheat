...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Base_HUD.BP_Base_HUD_C.SeasonColors
	 */
	struct ABP_Base_HUD_C_SeasonColors_Params
	{	};

	/**
	 * Function BP_Base_HUD.BP_Base_HUD_C.ApplyInvertAxis
	 */
	struct ABP_Base_HUD_C_ApplyInvertAxis_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_WMWR[0x4];                                   // 0x029C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_8H2E[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
