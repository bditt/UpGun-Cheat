...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function Custom_Screen_Button.Custom_Screen_Button_C.UpdatePlayerCosmeticData
	 * 		Flags  -> ()
	 */
	void UCustom_Screen_Button_C::UpdatePlayerCosmeticData()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Custom_Screen_Button.Custom_Screen_Button_C.UpdatePlayerCosmeticData");
		
		UCustom_Screen_Button_C_UpdatePlayerCosmeticData_Params params {};
