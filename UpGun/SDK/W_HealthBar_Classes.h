...
namespace CG
{
	...
	public:
		...
		class AUpGunBaseCharacter*                                 UpGunBaseCharacter;                                      // 0x0270(0x0008) Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash
