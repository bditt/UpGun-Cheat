...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Custom_Screen_Button.Custom_Screen_Button_C.UpdatePlayerCosmeticData
	 */
	struct UCustom_Screen_Button_C_UpdatePlayerCosmeticData_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_6C8H[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
