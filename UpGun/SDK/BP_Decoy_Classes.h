...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_QBAA[0x5];                                   // 0x050B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class AUpGunBaseCharacter*                                 UpGunBaseCharacter;                                      // 0x0510(0x0008) Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_JRKH[0x3];                                   // 0x0525(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
