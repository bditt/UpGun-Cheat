...
namespace CG
{
	...
	public:
		...
		class UBP_SAVE_C*                                          SAVELocal;                                               // 0x02E8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void GetResolutions();
		void GenTexte();
		void SetDaltonisme(int32_t Index);
		void Gnrationnompcrigolo();
		void Setantialiasing(int32_t* AliasingLevel);
		void Generatecombobox(class UComboBoxString** NewParam, TArray<class FText>* Options);
		void SetMotionBlur(bool* _bool_);
		void SetVsync(bool* _bool_);
		void ExecuteConsoleCommand(const class FString& Command, bool* _bool_, const class FString& Default, const class FString& Patatetrue);
		void SetSettings(class UGameUserSettings** Settings);
		void Regencomboboxes();
		void Construct();
