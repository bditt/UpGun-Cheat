...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Q2QH[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_ECP5[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function GI_BP_Upgun.GI_BP_Upgun_C.Load Saved Data
	 */
	struct UGI_BP_Upgun_C_LoadSavedData_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_GTEG[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_SQA3[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
