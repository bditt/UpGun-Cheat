...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_QM0O[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1W2H[0x3C];                                  // 0x0034(0x003C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TQOJ[0x3];                                   // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JMII[0x8];                                   // 0x00C8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_W5N2[0x458];                                 // 0x0028(0x0458) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8TJS[0x60];                                  // 0x0578(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_77UW[0x8];                                   // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EVFN[0x4];                                   // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3XCF[0x4];                                   // 0x026C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EXDE[0x8];                                   // 0x0680(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_M6C5[0x8];                                   // 0x0160(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FQ4Q[0x70];                                  // 0x0040(0x0070) MISSED OFFSET (PADDING)
