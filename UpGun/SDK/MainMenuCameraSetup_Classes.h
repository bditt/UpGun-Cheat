...
namespace CG
{
	...
	public:
		...
		class UObject*                                             SAVELocal;                                               // 0x0248(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FTransform                                          BaseLoc;                                                 // 0x0250(0x0030) Edit, BlueprintVisible, IsPlainOldData, NoDestructor
		class ABP_MainMenu_GameMode_C*                             MainMenuGameMode;                                        // 0x0280(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		unsigned char                                              UnknownData_8MVQ[0x8];                                   // 0x0288(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
