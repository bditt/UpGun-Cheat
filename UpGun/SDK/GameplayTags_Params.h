...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_8H4B[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	{
	public:
		unsigned char                                              UnknownData_H8FM[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
