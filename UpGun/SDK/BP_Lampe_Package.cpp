...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function BP_Lampe.BP_Lampe_C.Seasons
	 * 		Flags  -> ()
	 */
	void ABP_Lampe_C::Seasons()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Lampe.BP_Lampe_C.Seasons");
		
		ABP_Lampe_C_Seasons_Params params {};
