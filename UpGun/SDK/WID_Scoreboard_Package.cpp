...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function WID_Scoreboard.WID_Scoreboard_C.UpdateGamemode
	 * 		Flags  -> ()
	 */
	void UWID_Scoreboard_C::UpdateGamemode()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WID_Scoreboard.WID_Scoreboard_C.UpdateGamemode");
		
		UWID_Scoreboard_C_UpdateGamemode_Params params {};
	 ...
	 */
	void UWID_Scoreboard_C::UpdateTeams(TArray<struct FUpGunTeam> Teams)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WID_Scoreboard.WID_Scoreboard_C.Update Teams");
		
		UWID_Scoreboard_C_UpdateTeams_Params params {};
		params.Teams = Teams;
