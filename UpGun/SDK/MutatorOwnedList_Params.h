...
namespace CG
{
	 ...
	 */
	struct UMutatorOwnedList_C_GenerateMutatorList_Params
	{
	public:
		...
		unsigned char                                              UnknownData_C68H[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
