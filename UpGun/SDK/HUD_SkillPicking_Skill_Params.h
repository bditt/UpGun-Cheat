...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function HUD_SkillPicking_Skill.HUD_SkillPicking_Skill_C.UpdateTestedUpgrades
	 */
	struct UHUD_SkillPicking_Skill_C_UpdateTestedUpgrades_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_LLMX[0x6];                                   // 0x0012(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
