...
namespace CG
{
	 ...
	 */
	void UGA_Skill_SecondaryWeapon_GrenadeLauncher_C::GetWeapon(class UPrimitiveComponent** Weapon)
	{
		...
		UGA_Skill_SecondaryWeapon_GrenadeLauncher_C_GetWeapon_Params params {};
