...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_A4AA[0x3];                                   // 0x0239(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WKXM[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		TArray<class AActor*>                                      ActorstoIgnore;                                          // 0x0250(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate, ExposeOnSpawn
