...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AJHE[0x4];                                   // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_X77A[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
