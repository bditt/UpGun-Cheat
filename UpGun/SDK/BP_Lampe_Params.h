...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Lampe.BP_Lampe_C.Seasons
	 */
	struct ABP_Lampe_C_Seasons_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_EVEY[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
