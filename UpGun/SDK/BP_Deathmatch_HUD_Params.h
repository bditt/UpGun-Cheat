...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_IVPH[0x6];                                   // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct ABP_Deathmatch_HUD_C_OnAmmoorMagazineChanged_Params
	{
	public:
		...
		unsigned char                                              UnknownData_GPS1[0x6];                                   // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_H37M[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
