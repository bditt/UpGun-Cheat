...
namespace CG
{
	 ...
	 */
	struct ABP_Lobby_HUD_C_OnAmmoorMagazineChanged_Params
	{
	public:
		...
		unsigned char                                              UnknownData_L47C[0x6];                                   // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_G1HJ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
